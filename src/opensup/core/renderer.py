...
Bitmap rendering engine for PGS subtitle objects.

Handles the conversion of parsed subtitle events into composited
bitmap images. Supports cropping, scaling, palette application,
anti-aliasing, and multiple rendering strategies depending on
the complexity of each display set.

Why a dedicated module: rendering is computationally intensive
and benefits from isolated optimisation (vectorisation, caching)
...
from opensup.core.segments import DisplaySet, PCS, WDS, PDS, ODS, ENDS, WindowDefinition, CObject, Epoch
from opensup.media.optimizer import Optimise
from opensup.media.pgraphics import PGraphics, PGDecoder, PGObjectBuffer, PaletteManager, ProspectiveObject
from opensup.media.pgstream import EpochContext
from opensup.media.palette import Palette, PaletteEntry
from opensup.core.filestreams import BDNXML
